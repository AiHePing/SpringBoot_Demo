...
import com.eastcom.impl.beanPostProcessor.EnableEcho_BeanPostProcessor;

public class EnableEcho_BeanRegistrar implements ImportBeanDefinitionRegistrar {
	...
	public void registerBeanDefinitions(AnnotationMetadata importingClassMetadata, BeanDefinitionRegistry registry) {
		...
		BeanDefinitionBuilder builder = BeanDefinitionBuilder.rootBeanDefinition(EnableEcho_BeanPostProcessor.class);
